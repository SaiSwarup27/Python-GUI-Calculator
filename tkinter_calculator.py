...
button_1 = tk.Button(
    master=frame, text="1", padx=15, pady=5, width=3, command=lambda: myclick(1)
)
...
button_clear = tk.Button(
    master=frame, text="clear", padx=15, pady=5, width=12, command=clear
)
button_clear.grid(row=6, column=1, columnspan=2, pady=2)

button_equal = tk.Button(
    master=frame, text="=", padx=15, pady=5, width=9, command=equal
)
